   ...
   public  class SampleScmDataFixture : IDisposable
    {
        ...
        private const string PartTypeTable = @"CREATE TABLE PartType(Id INTEGER PRIMARY KEY,Name VARCHAR(255) NOT NULL);";
        ...
        private const string PartCommandTable = @"CREATE TABLE PartCommand(
